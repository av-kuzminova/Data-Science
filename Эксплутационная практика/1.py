...
# Построим гистограммы и графики плотности распределения для числовых переменных
# Однако они не будут отображаться, поскольку нам нужно только сохранить отчёт
...
# В этом коде графики не будут отображаться, так как выводится только итоговый отчет